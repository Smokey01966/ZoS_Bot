module.exports.run = async (bot, message, args) => {
    ...
    lotoPropRef.once("value").then(function(snapshot){
        ...
        lotoTicketRef.child(winningTicketNumber).once("value").then(function(snapshot){
            ...
            channel.send(`Bonus lottery ticket number ${winningTicketNumber} drawn ${gw2AccountDis} wins!`)
        })
    })
}
module.exports.help = {
    name: "drawbonuslottery"//Change to name of command
}
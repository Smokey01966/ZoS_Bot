module.exports.run = async (bot, message, args) => {
    ...
    .setTitle("Add Bonus Tickets Command")
    .setColor("#3d7d05")
    .addField("Format", `${botConfig.prefix}addbonustickets|(Gw2Account)|(Number of Tickets to Assign)`)
    .addField("Gw2Account", "The member's Guild Wars2 account including the .####")
    .addField("Number of Tickets to Add", "How many bonus lottery tickets you want to assign to the member")
    sender.send(messageEmbed);
}
module.exports.help = {
    name: "addbonusticketshelp"//Change to name of command
}